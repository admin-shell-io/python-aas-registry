...
VWS_AAS_Registry License under Apache 2.0, the complete license text including the copy rights is included under [License.txt](https://github.com/admin-shell-io/VWS_AAS_Registry/blob/main/LICENSE.txt)
